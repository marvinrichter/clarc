...
This guide helps you migrate from Claude Code to OpenCode while using the clarc configuration.
...
- **clarc**: [github.com/marvinrichter/clarc](https://github.com/marvinrichter/clarc)
