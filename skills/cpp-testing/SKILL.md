...
For parameterized tests, death tests, advanced gmock (InSequence, DoAll, SaveArg), matcher reference, test data factories, async/concurrent testing, CI/CD matrix, Catch2, and anti-patterns — see `cpp-testing-advanced`.
