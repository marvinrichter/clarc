...
For security anti-patterns (localStorage token storage, client-side auth checks, error detail leaks, blacklist vs whitelist validation, `npm install` in CI), resources, and the full reminder — see skill `security-review-advanced`.
