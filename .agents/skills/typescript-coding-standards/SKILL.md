...
description: "TypeScript, JavaScript, React, and Node.js coding standards — naming conventions, immutability, error handling, async patterns, component structure, API design."
---

# TypeScript / JavaScript Coding Standards

TypeScript, JavaScript, React, and Node.js specific coding standards with concrete code examples.
